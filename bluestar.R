...
merged_df %>% 
  summarize(total_miles_original = sum(miles))
miles <- total_milage_optimized %>% 
  summarize(total_miles = sum(total_milage))
miles %>% 
  summarize(miles = sum(total_miles))
